...
- Instead, a common practice is to download a pre-trained model and use it aout of the box or fine tune it for your task. This is called **transfer learning**.
- It's similar to using your general knowledge of languages to quickly learn a new, related one.
...
- That's it for the module! Let's practice what you've just learned. 
