...
- We are using Quarto to create slides, with live code running in the background. You can access the source for this website and our slides on this GitHub page [https://github.com/kvarada/Intro-to-ML-workshop-2024](https://github.com/kvarada/Intro-to-ML-workshop-2024)
